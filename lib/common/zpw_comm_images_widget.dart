...
class ZpwCommImagesWidget extends StatefulWidget {
  final List<String> images;
  final int initialPage;
  final int groupId;
  final void Function(int index)? onPageChanged;

  const ZpwCommImagesWidget({
    super.key,
  ...
  @override
  State<ZpwCommImagesWidget> createState() => _ZpwCommImagesWidgetState();
}

class _ZpwCommImagesWidgetState extends State<ZpwCommImagesWidget> {
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Container(
          ...
          width: 1.sw,
          height: 1.sh,
          child: ZpwQdsImage(widget.images[validIndex], 1.sw, 1.sh,
              fit: BoxFit.contain),
        );
      },
    );
